...
parser.add_argument("--noprepare", action='store_true', help="Do not prepare environment", default=True)
parser.add_argument("--memory-ratio-allow", type=float, default=0.1, help="ratio of avaiable memory that allow in generation")
parser.add_argument("--memory-check-interval", type=float, default=1, help="interval by seconds for memory check in generation")
parser.add_argument("--memory-timeout", type=float, default=20, help="timeout by seconds for throw exception when out of memory occured in generation")
parser.add_argument("--gpu-memory-fraction", type=float, default=0.7, help="memory allow for allocating otherwise throw exception in generation")
parser.add_argument('--additional-lora', type=str, help='additional lora dir', default=None)
parser.add_argument('--additional-model', type=str, help='additional model dir', default=None)
parser.add_argument('--additional-embedding', type=str, help='additional embedding dir', default=None)
